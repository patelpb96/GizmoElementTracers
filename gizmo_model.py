...
class feedback(source = 'cc'):
    assert source.lower() in feedback_type

    def get_rate_wind(ages, Z = Z_0, massloss = True, metal_mass_fraction = None, model = 'wind', element_name = False):
